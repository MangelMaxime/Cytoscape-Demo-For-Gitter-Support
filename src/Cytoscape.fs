...
let [<Import("*","cytoscape")>] cytoscape: IExports = jsNative
...
module Cytoscape =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        /// <param name="module">
        /// Entry point for the extension, got by module = require('cy-ext')
        /// or by import module from 'cy-ext'
        /// <see href="http://js.cytoscape.org/#extensions" />
        /// </param>
        abstract ``use``: ``module``: Ext -> unit
        /// <summary>Surpress Cytoscape internal warnings globally with a flag.</summary>
        /// <param name="condition">
        /// If true, all Cytoscape warnings are surpressed.
        /// <see href="https://js.cytoscape.org/#core/initialisation" />
        /// </param>
        abstract warnings: condition: bool -> unit
    ...
    type [<AllowNullLiteral>] CoreData =
        ...
        abstract data: obj: obj -> CoreData
        /// <summary>Get the entire data object or a particular data field.</summary>
        ...
        abstract attr: obj: obj -> CoreData
        /// <summary>
